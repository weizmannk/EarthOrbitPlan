...
.. dropdown:: Notebooks & Resources
    ...
    .. :tab-set::
        ...
        .. tab-item:: Gravitational-wave detection simulation
            ...
            - The generated signals are subjected to a detectability threshold based on the signal-to-noise ratio (SNR) for each detector network, corresponding to the O4 or O5 configurations.

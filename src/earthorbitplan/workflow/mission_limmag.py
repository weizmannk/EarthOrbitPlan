...
def process(plan_args, mission, hpx, skymap, observations, footprints):
    ...
    The Cerenkov / AE8 background (ULTRASAT only) is part of the mission
    background model in m4opt >= 2.13 and is applied automatically from the
    observer_location / obstime of each observing() context below.
    """
    snr = plan_args["snr"]
